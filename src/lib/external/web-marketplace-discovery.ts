...
function discoveryNote(item: RawDiscovery) {
  ...
  return `${freshness} ${availability} Experimental web discovery only: it may still be sold, login-gated, region-blocked, stale, or indirectly indexed. Open manually or paste the exact URL back into Lens TCG before comparing.`;
}
