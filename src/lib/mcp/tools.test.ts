...
function listingFor(cardValue: CardIdentityCandidate): NormalizedListing {
  return {
    ...
    shipping: 0, buyerFee: 0, costComplete: true, estimatedTax: 34.69, preTaxTotal: 405, estimatedLandedCost: 439.69, claimedCondition: "Near Mint", listingLanguage: "English",
