...
describe("comparison report cache", () => {
  ...
  it("keys by card, condition, and delivery context", () => {
    ...
    expect(key).toBe(`identity-v4|ranking-v6-sales-market-buyer-fees|${ONE_PIECE_PRINT_METADATA_REVISION}|${ONE_PIECE_CATALOG_REVISION}|swsh7-215|Near Mint|10001|0.08`);
  });
