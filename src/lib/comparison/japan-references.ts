...
function manualNote(source: string) {
  return `${source} was not fetched or analyzed by Lens TCG. Open this Japan price/buy search manually; paste a specific listing back into Lens TCG if you want it ranked with the other evidence.`;
}
