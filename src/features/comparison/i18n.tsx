...
const en = {
  ...
  hero: {
    ...
    subtitle:
      "Search your card once. Lens TCG compares live listings and gives you one pick, the catch, and when to pass — before you pay.",
  },
  form: {
...
const zh: Dict = {
  ...
  hero: {
    ...
    title: "哪条商品才真的值得买？",
    subtitle:
      "输入一次卡片，Lens TCG 比较在售商品，给出一条推荐、一个隐患，以及该放弃的时候——在你付款之前。",
  },
  form: {
    heading: "从卡名开始",
    stepOne: "查找卡片",
  ...
  result: {
    ...
    noRecommendationBody: "目前没有同时满足卖家明确品相与完整可比总价的商品。请查看被跳过的结果，或贴入具体商品链接；Lens TCG 不会替你猜。",
    ...
    nextMovesBody: "Lens TCG 这次没有找到可以安心推荐的商品。你仍可补充卡片信息、重试来源、贴入具体商品，或查看下方的手动市场查询。",
    ...
    sellerPhotosDisclaimer: "照片由 eBay 卖家提供；Lens TCG 未验证卡片品相或真伪。",
    ...
    japanPriceChecksBody:
      "打开这些日本站内搜索，自己查看日元价格和购买路径。Lens TCG 没有抓取或排序这些页面；如果看到具体商品，可以把链接粘回来再比对。",
    askTitle: "追问这次结果",
