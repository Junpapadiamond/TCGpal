...
const en = {
  ...
  form: {
    ...
    detailsToggle: "Prefer to fill in game, set, and collector number separately?",
    gameLabel: "Card game",
    ...
    ledgerToggle: "Have a listing on a marketplace we don't support yet? Add it (fallback)",
    ledgerHelp:
...
const zh: Dict = {
  ...
  form: {
    ...
    ledgerToggle: "有我们暂不支持的平台商品？添加它（备用方式）",
    ledgerHelp:
