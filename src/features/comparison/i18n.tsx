...
export const en = {
  ...
  result: {
    ...
    aggregateReferenceOnly: "Aggregate reference only, not ranked live seller inventory.",
    marketReferenceUnavailable: "Exact TCGplayer mapping unavailable",
    mercariManualNote: "Search Mercari US manually; TCGlens does not claim price, availability, or seller facts here.",
    whatnotManualNote: "Search Whatnot manually. Much of it is live auctions, so a total cost cannot be compared here.",
    tcgplayerSearchNote: "No market reference matched this print. Opens a TCGplayer search to check by hand; nothing here is fetched or ranked.",
    snkrdunkManualNote: "Japan/JPY context. Review the result and checkout path manually.",
...
export const zh: Dict = {
  ...
  result: {
    ...
    aggregateReferenceOnly: "这里只是汇总市价参考，不是参与排序的实时卖家商品。",
    marketReferenceUnavailable: "没有确切的 TCGplayer 映射",
    mercariManualNote: "手动搜索美国 Mercari（煤炉）；这里不声称价格、库存或卖家信息。",
    whatnotManualNote: "手动搜索 Whatnot。上面多为直播拍卖，无法在这里比总价。",
    tcgplayerSearchNote: "没有匹配到这个版本的参考价。点开是 TCGplayer 搜索，需你自己核对；这里不抓取、不排名。",
    snkrdunkManualNote: "日本 / 日元场景，请自己核对搜索结果和结账路径。",
