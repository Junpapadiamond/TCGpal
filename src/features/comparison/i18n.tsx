...
const en = {
  ...
  howItWorks: {
    eyebrow: "How a trustworthy comparison works",
    ...
    s3t: "Compare like with like",
    s3d: "Fixed rules enforce condition, language, and complete-cost compatibility before ranking.",
    s4t: "Show the limits",
    s4d: "Unknown data stays unknown; no invented comps or grading promises.",
...
const zh: Dict = {
  ...
  howItWorks: {
    ...
    s3t: "只比较同类商品",
    s3d: "固定规则先核对品相、语言和完整总价，再参与排序。",
    s4t: "把限制说清楚",
    s4d: "未知信息保持未知，不编造成交价，也不作评级承诺。",
    supportedLabel: "目前支持：",
    supportedBody:
