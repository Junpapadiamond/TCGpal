...
const en = {
  ...
  card: {
    ...
    mathRiskFormula: "= 60% seller trust + 40% evidence",
    mathValueFormula: "= 50% price + 30% risk + 20% evidence",
...
const zh: Dict = {
  ...
  card: {
    ...
    mathRiskFormula: "= 60% 卖家可信度 + 40% 证据",
    mathValueFormula: "= 50% 价格 + 30% 风险分 + 20% 证据",
