...
const en = {
  ...
  form: {
    ...
    buyingContextHelp: "Optional. Sets the minimum condition and delivery ZIP used for totals. You can change lenses after the result loads.",
    cardDetails: "Card details: name, set, collector number",
    changeContext: "Change",
    preTaxContext: "Pre-tax",
  ...
  loading: {
    // Truthful, phase-specific copy. There is no per-step streaming signal, so
    // the UI states which whole job is running rather than showing completed
    // checkmarks for work whose progress is unknown.
    resolving: "Finding the exact card and checking available listings…",
    comparing: "Comparing live listings for this exact print…",
    retrying: "Trying the comparison again…",
    subnote: "This can take a few seconds while TCGpal checks sources.",
  },
  error: {
...
const zh: Dict = {
  ...
  form: {
    ...
    buyingContext: "购买背景",
    buyingContextHelp: "可选。设置计算总价所用的最低品相与收货邮编。结果出来后仍可切换角度。",
    cardDetails: "卡片信息：卡名、系列、收藏编号",
    changeContext: "修改",
    preTaxContext: "税前",
  ...
  loading: {
    resolving: "正在锁定确切卡片并查看在售商品…",
    comparing: "正在为这个确切版本比较在售商品…",
    retrying: "正在重新比对…",
    subnote: "TCGpal 正在查询来源，可能需要几秒钟。",
  },
  error: {
    title: "这次比对需要再试一次。",
    retry: "立即重试",
