...
export const en = {
  ...
  result: {
    ...
    whatnotBestPick: "Best on Whatnot",
    ...
    whatnotShippingAtCheckout: "+ shipping at checkout",
    whatnotReviews: (count: number) => `${count.toLocaleString("en-US")} reviews`,
    whatnotNoReviews: "No reviews yet",
    whatnotPhotos: (count: number) => `${count} photo${count === 1 ? "" : "s"}`,
    whatnotOpen: "View on Whatnot",
    whatnotCount: (count: number) => `${count} live buy-now listing${count === 1 ? "" : "s"}`,
...
export const zh: Dict = {
  ...
  result: {
    ...
    whatnotShippingAtCheckout: "＋结账时另计运费",
    whatnotReviews: (count: number) => `${count.toLocaleString("zh-CN")} 条评价`,
    whatnotNoReviews: "暂无评价",
    whatnotPhotos: (count: number) => `${count} 张照片`,
    whatnotOpen: "去 Whatnot 查看",
    whatnotCount: (count: number) => `${count} 个在售一口价商品`,
