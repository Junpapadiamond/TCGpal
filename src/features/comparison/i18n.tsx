...
const en = {
  ...
  hero: {
    ...
    subtitle:
      "Search your card once. TCGpal compares live listings and gives you one pick, the catch, and when to pass — before you pay.",
  },
  form: {
...
const zh: Dict = {
  ...
  hero: {
    ...
    title: "哪条商品才真的值得买？",
    subtitle:
      "输入一次卡片，TCGpal 比较在售商品，给出一条推荐、一个隐患，以及该放弃的时候——在你付款之前。",
  },
  form: {
    heading: "从卡名开始",
    stepOne: "查找卡片",
