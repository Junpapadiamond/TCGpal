...
const en = {
  ...
  result: {
    ...
    printReason: (reason: string) => ({
      ...
      plain_family_listing_matches_base_print: "This collector number has only one print, so the listing matches it.",
      silent_title_implies_base_print: "This number has one base print and one alternate art; the listing names no alternate, and its price matches the base print.",
...
const zh: Dict = {
  ...
  result: {
    ...
    printReason: (reason: string) => ({
      ...
      plain_family_listing_matches_base_print: "该收藏编号只有一个版本，商品与其一致。",
      silent_title_implies_base_print: "该编号只有普通版和一个异画版；商品未标注异画，且价格与普通版一致。",
