...
const en = {
  ...
  result: {
    ...
    nextMovesBody: "Lens TCG did not find a listing it can safely recommend. You can still refine the card details, retry a source, paste a listing, or open the manual market checks below.",
    ...
    japanPriceChecksBody:
      "Open these Japanese search pages to inspect yen prices and buy paths yourself. Lens TCG has not fetched or ranked those pages; paste a specific listing back here to compare it.",
...
const zh: Dict = {
  ...
  result: {
    ...
    noRecommendationBody: "现在没有品相和总价都说得清的商品。可以看看被跳过的那些，或者直接贴一条链接进来——我们不替你猜。",
    inspectFirstTitle: "最值得先看的一条",
    inspectFirstBody: "这条也许有用，但文字信息还证明不了它就是你确认的那张卡图。先看卖家照片，再打开商品页确认，然后再决定。",
    inspectListing: "去核对",
    nextMovesTitle: "暂时没有能放心买的",
    nextMovesBody: "这次没找到能放心推荐的商品。你可以补卡片信息、重试来源、贴一条链接进来，或者用下面的手动市场查询。",
    ...
    japanPriceChecksBody:
      "这些是日本站的搜索页，自己打开看日元价格和购买路径。Lens TCG 没抓取也没给这些页面排序；看到具体商品，把链接贴回来再比。",
    askTitle: "追问这次结果",
