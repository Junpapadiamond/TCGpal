/**
 * Founder-triggered frontier research only. Self-contained, read-only DOM reader
 * for the supported browser tool's evaluate(). No network, cookies, hidden app
 * state, seller profiles, or production imports. Selectors observed 2026-09-14.
 */
export function readMercariDocument(doc, { sourceUrl, observedAt, limit = 6 }) {
  ...
  const record = { label: "frontier-research", sourceUrl, observedAt, acquisitionMethod: "browser-dom",
