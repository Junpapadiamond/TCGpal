...
| WS-UX | Best Buy / Inspect First / Next Moves experience | Medium refactor | Decision block de-genericised and deployed at `2ac0c6c` | Observe trust, sharing, and empty outcomes |
| WS-DISTRIBUTION | Agent interfaces, plugins, and additional marketplaces | Mixed | MCP released; retrieval-agent plan written, not started | Run Phase 0 of `docs/plan-retrieval-agent-2026-08-10.md` (baseline recall) before touching the agent |
