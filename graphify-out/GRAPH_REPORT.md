...
## Corpus Check
- 118 files · ~370,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1232 nodes · 2330 edges · 76 communities (66 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26f71024`
...
Cohesion: 0.06
Nodes (35): buildMarqueeItems(), CardMarquee(), conditions, evidenceVerdict(), fallbackCardBacks, gameTiles, HoloCardArt(), ListingMetaLine() (+27 more)
...
Cohesion: 0.07
Nodes (29): buyerContextSchema, CardHint, cardHintSchema, comparisonNarrativeSchema, comparisonPlatformResultSchema, ComparisonQuestionResponse, comparisonQuestionResponseSchema, comparisonReferenceSchema (+21 more)
...
Cohesion: 0.18
Nodes (13): applyMarketAnchor(), buildMarketReference(), buildNarrative(), buildSoldReference(), dedupeSeeds(), formatAnchorDate(), localNarrative(), runListingComparison() (+5 more)
...
### Community 20 - "useT"
Cohesion: 0.11
Nodes (23): CandidateRow(), CardKeyPreview(), choiceReasonText(), ComparisonQuestionBox(), ComparisonResult(), DecisionReceipt(), ErrorNotice(), Footer() (+15 more)

### Community 21 - "market-agent.ts"
Cohesion: 0.19
Nodes (18): AgentMessage, AGENT_SYSTEM_PROMPT, AllocatorDialect, createAgentModel(), createChatCompletionsAgentModel(), createOpenAiAgentModel(), createResponsesAgentModel(), fetchWithTimeout() (+10 more)

### Community 22 - "platforms.ts"
Cohesion: 0.12
Nodes (21): runAgentFanout(), DEFAULT_AGENTS, ebayPlatformAgent, PlatformAgent, PlatformFanout, PlatformOutcome, PlatformSearchInput, PlatformSearchPlan (+13 more)
...
Cohesion: 0.20
Nodes (11): AgentDecision, AgentModel, AgentRun, AgentStep, AgentTool, AgentToolCall, AgentToolResult, runAgent() (+3 more)
...
Cohesion: 0.17
Nodes (22): CATALOG_RETRY_DELAYS_MS, collectorNumberParts(), detectIdentityMismatch(), evaluateIdentity(), evaluateIdentityFields(), evaluateOnePieceMatch(), extractCollectorNumber(), extractTcgplayerPricing() (+14 more)
...
Cohesion: 0.29
Nodes (9): clearComparisonCache(), comparisonCacheKey(), getCachedComparison(), isCacheableRequest(), setCachedComparison(), pureSearch, clearLocalCache(), comparisonReportSchema (+1 more)

### Community 37 - "standard-comparison-flow.ts"
Cohesion: 0.15
Nodes (16): clearCrosswalkCache(), clearLocalRateLimitStore(), ConditionClaim, assertStandardComparisonFlowPlan(), buildStandardComparisonRequest(), runStandardComparisonFlow(), selectConfirmationId(), STANDARD_COMPARISON_FLOW_CARDS (+8 more)
...
Cohesion: 0.28
Nodes (12): POST(), POST(), request, createRequestId(), OpsRoute, rateLimitHeaders(), rateLimitRequest(), captureOperationalException() (+4 more)
...
Cohesion: 0.24
Nodes (11): cleanCardName(), confidenceRank(), dedupeIdentities(), errorMessage(), identifyCards(), identifyOnePieceCards(), ingestSourceListing(), mergeSourceFacts() (+3 more)
...
Cohesion: 0.38
Nodes (4): IdentityConfirmation(), groupIdentitiesBySet(), IdentityGroup, CardIdentityCandidate
...
- **Why does `CardIdentityCandidate` connect `CardIdentityCandidate` to `one-piece-tcg.ts`, `ComparisonApp.tsx`, `japan-references.ts`, `ebay.ts`, `tcgcsv.ts`, `web-marketplace-discovery.ts`, `schemas.ts`, `market-agent.test.ts`, `market-agent.ts`, `platforms.ts`, `standard-comparison-flow.ts`, `route.ts`, `evaluateIdentityFields`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Marketplace` connect `universal-listing.ts` to `events.ts`, `ComparisonApp.tsx`, `ranking.ts`, `web-marketplace-discovery.ts`, `schemas.ts`, `comparison-form-state.ts`, `market-agent.test.ts`, `i18n.tsx`, `platforms.ts`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `card()` connect `one-piece-tcg.ts` to `ComparisonExperience`, `ComparisonApp.tsx`, `standard-comparison-flow.ts`, `build-optcg-catalog.mjs`?**
